...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ModelsAccount', 'model/ModelsAuthInfo', 'model/ModelsBillingPortalSession', 'model/ModelsBulkResponse', 'model/ModelsCountStat', 'model/ModelsCountry', 'model/ModelsCoupon', 'model/ModelsCouponOptions', 'model/ModelsCreditsInfo', 'model/ModelsDeleteResponse', 'model/ModelsEAccount', 'model/ModelsEAccountMember', 'model/ModelsEmailList', 'model/ModelsJobStatus', 'model/ModelsMember', 'model/ModelsPaymentAddress', 'model/ModelsPaymentOptions', 'model/ModelsPaymentStatus', 'model/ModelsPricing', 'model/ModelsSingleValidatedEmail', 'model/ModelsTaxDetails', 'model/ModelsValidatedEmailList', 'model/ModelsValidationJob', 'model/ModelsValidationReason', 'api/AccountmemberApi', 'api/AccountpaymentApi', 'api/AccountsettingApi', 'api/AccountvalidationApi', 'api/AuthApi', 'api/ClusterApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ModelsAccount'), require('./model/ModelsAuthInfo'), require('./model/ModelsBillingPortalSession'), require('./model/ModelsBulkResponse'), require('./model/ModelsCountStat'), require('./model/ModelsCountry'), require('./model/ModelsCoupon'), require('./model/ModelsCouponOptions'), require('./model/ModelsCreditsInfo'), require('./model/ModelsDeleteResponse'), require('./model/ModelsEAccount'), require('./model/ModelsEAccountMember'), require('./model/ModelsEmailList'), require('./model/ModelsJobStatus'), require('./model/ModelsMember'), require('./model/ModelsPaymentAddress'), require('./model/ModelsPaymentOptions'), require('./model/ModelsPaymentStatus'), require('./model/ModelsPricing'), require('./model/ModelsSingleValidatedEmail'), require('./model/ModelsTaxDetails'), require('./model/ModelsValidatedEmailList'), require('./model/ModelsValidationJob'), require('./model/ModelsValidationReason'), require('./api/AccountmemberApi'), require('./api/AccountpaymentApi'), require('./api/AccountsettingApi'), require('./api/AccountvalidationApi'), require('./api/AuthApi'), require('./api/ClusterApi'));
  }
}(function(ApiClient, ModelsAccount, ModelsAuthInfo, ModelsBillingPortalSession, ModelsBulkResponse, ModelsCountStat, ModelsCountry, ModelsCoupon, ModelsCouponOptions, ModelsCreditsInfo, ModelsDeleteResponse, ModelsEAccount, ModelsEAccountMember, ModelsEmailList, ModelsJobStatus, ModelsMember, ModelsPaymentAddress, ModelsPaymentOptions, ModelsPaymentStatus, ModelsPricing, ModelsSingleValidatedEmail, ModelsTaxDetails, ModelsValidatedEmailList, ModelsValidationJob, ModelsValidationReason, AccountmemberApi, AccountpaymentApi, AccountsettingApi, AccountvalidationApi, AuthApi, ClusterApi) {
  'use strict';
