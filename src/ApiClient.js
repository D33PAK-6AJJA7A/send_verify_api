...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.SendVerifyApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api-stag.sendverify.io/api/v1
     */
    this.basePath = 'https://api-stag.sendverify.io/api/v1'.replace(/\/+$/, '');
