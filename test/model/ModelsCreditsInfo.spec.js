...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelsCreditsInfo', function() {
      beforeEach(function() {
        instance = new SendVerifyApi.ModelsCreditsInfo();
      });

      it('should create an instance of ModelsCreditsInfo', function() {
        // TODO: update the code to test ModelsCreditsInfo
        expect(instance).to.be.a(SendVerifyApi.ModelsCreditsInfo);
      });
